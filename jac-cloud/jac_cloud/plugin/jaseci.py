...
from ..jaseci.security import authenticator, authenticator_webhook, validate_request
...
def populate_apis(cls: Type[WalkerArchitype]) -> None:
    ...
    if (specs := get_specs(cls)) and not specs.private:
        ...
        is_webhook: bool = specs.is_webhook
        ...
        if is_webhook:
            target_authenticator = authenticator_webhook
